...
# IsleActivity, so this list is the whole JNI surface; the GameImport, GameFileCopier and
# QuitPrompt classes it delegates to are reached only from Java and deliberately have no keep rule
# of their own.
#
